...
<html lang="en">
  ...
  <?php include('components/Navbar/navbar.php'); ?>
    ...
    <div class="container">
        <form class="hero-form mt-lg-5 mt-3 mb-5 input-group w-lg-50 mx-auto">
            <select
              name="year"
              class="year bg-form-color text-light form-control"
            >
            ...
            <select
              name="brand"
              class="brand bg-form-color text-light form-control"
            >
              <option value="2021">2021</option>
              <option value="2022">2022</option>
              <option value="2023">2023</option>
        ...
        <div class="col-12 mb-5">
            <h2 class="text-capitalize mb-5 mt-3 text-primary" style="font-family: var(--font-main-fancy);">search results on <a href="" class="ms-2 text-hightlight text-uppercase fs-4" style="font-family: var(--font-main-semibold);">vehicle name</a></h2>
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4">
                  <div class="card">
                    ...
                    >
                      <div
                        class="bookmark position-absolute end-0 me-3 mt-3 btn btn-warning rounded-5"
                      >
                    ...
                    <div class="card-footer d-flex justify-content-around">
                      ...
                      <a
                        href=""
                        class="text-uppercase text-reset fw-semibold text-decoration-none"
                        >view more
                        <i
                          style="font-size: 0.8em"
                          class="fa-solid fa-arrow-up-right-from-square ps-2"
                        ></i
                      ></a>
                    </div>
                  </div>
    ...
    <footer class="text-center text-lg-start bg-footer-bg text-muted">
      <section
        class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom text-light"
      >
        <!-- Left -->
        <div class="me-5 d-none d-lg-block">
          <span class="text-capitalize"
            >stay in touch with our social networks</span
          >
        </div>
        <!-- Left -->
      ...
      <!-- Copyright -->
      <div
        class="text-center p-4 text-light border-top"
        style="background-color: rgba(0, 0, 0, 0.05)"
      >
        © 2024 Copyright:
        <a
          class="text-reset fw-bold text-decoration-none"
          href="https://nadun.web.lk"
          >NadSoft.lk</a
        >
      </div>
      <!-- Copyright -->
