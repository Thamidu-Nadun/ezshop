					...
					<thead class="thead-dark">
						...
						<tbody>
							...
							foreach ($result as $row) {
								...
								<tr>
									<td><?php echo $i; ?></td>
									<td style="width:82px;"><img src="img/vehicles/<?php echo $row['p_main_photo']; ?>" alt="<?php echo $row['p_name']; ?>" style="width:80px;"></td>
									...
									<td><?php echo $row['tcat_name']; ?> / <?php echo $row['mcat_name']; ?>/<br><?php echo $row['ecat_name']; ?></td>
									<td>										
										<a href="product-edit.php?tcat_id=<?php echo $row['p_id']; ?>" class="btn btn-primary btn-xs">Edit</a>
